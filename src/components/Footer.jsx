...
function Footer() {
  return (
    <div data-scroll data-scroll-section  className='flex gap-5 w-full bg-[#ffffff] text-[#212121] py-20 px-20 '>
      <div className="w-1/2 flex flex-col justify-between  font-oswald 
    font-oswald ">
    <div className="headings ">
    <h1 className='text-[8vw]  leading-none -mb-10 uppercase text-semibold'>Eye-</h1>
    <br /><br />
    <h1 className='text-[8vw]  leading-none -mb-10 uppercase text-semibold'>opening</h1>
    </div>
    <svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="w-1/2">
      <h1 className='text-[8vw]  leading-none -mb-10 uppercase text-semibold font-oswald'>Presentation
      </h1>
        <div className="dets font-['Neue_Montreal'] capitalize ">
            <h3 className='text-[1.1vw] text-light mt-20'>S:</h3>
            <div className="sub-s mt-8">
            <a  className="block text-[1.1vw] font-light" href="#">facebook</a>
            <a  className="block text-[1.1vw] font-light" href="#">Instagram</a>
            <a  className="block text-[1.1vw] font-light" href="#">Twitter</a>
            <a  className="block text-[1.1vw] font-light" href="#">linkedIn</a>
            </div>

        </div>
        <div className="dets font-['Neue_Montreal'] capitalize ">
            <h3 className='text-[1.1vw] text-light mt-8'>L:</h3>
            <div className="sub-s mt-8">
            <a  className="block text-[1.1vw] font-light" href="#">202-1965 W 4th Ave <br />
            Vancouver, Canada</a>
            <a  className="pt-20 block text-[1.1vw] font-light" href="#">30 Chukarina St <br />
            Lviv, Ukraine</a>
            </div>

        </div>
        <div className="dets font-['Neue_Montreal'] capitalize ">
            <h3 className='text-[1.1vw] text-light mt-20'>E:</h3>
            <div className="sub-s mt-8">
            <a  className="block text-[1.1vw] font-light" href="#">hello@ochi.design</a>
            </div>
        </div>
